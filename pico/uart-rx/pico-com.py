...
payload_256_bytes = """ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-"""
...
for seq in range(1, NUM_PACKETS + 1):
    ...
    seq_payload = bytes([seq])
    payload = payload_256_bytes.encode('utf-8')
    frame   = build_frame(seq_payload)
