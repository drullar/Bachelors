...
architecture behavior of tb_ethernet_receive is
  ...
  signal pico_uart_out : std_logic := '0';
  signal fpga_uart_out : std_logic := '0';
...
begin
  ...
  ethernet_controller_inst : entity work.ethernet_controller
    ...
    (
      ...
      clk48_sim           => clk48,
      clk20_sim           => clk20,
      uart_in             => pico_uart_out,
      uart_out            => fpga_uart_out,
      manchester_data_in  => Ethernet_TDp,
      manchester_data_out => Ethernet_TDp
    );

  pico_sim : entity work.pico_sim
    port map
    (
      clk     => clk48,
      rst     => '0',
      tx_line => pico_uart_out,
      tx_done => open
    );
